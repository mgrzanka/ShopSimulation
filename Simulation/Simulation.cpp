...
{
    if(days == 0 || starting_hour == 0 || ending_hour == 0 || starting_hour > ending_hour) throw std::invalid_argument("In constructor of simulation: this simulation data can't be a zero");
